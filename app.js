...
const saveTaxes= document.getElementById('saveTaxes')
...
calculate.addEventListener ('click', (event)=> {
    ...
    total = taxes.filter ((el) => el.freq.includes ('total'))
...
convert.addEventListener ('click',(event)=> {
    ...
    if (total.length>=1){
        ...
        <li class="breakdownhtmlConv"> Precio neto:  ${(netValue*res)}</li>
        <li class="breakdownhtmlConv"> ${printConvIncCiclo} </li>
        <li class="breakdownhtmlConv"> ${printConvExcCiclo} </li>
        <li class="breakdownhtmlConv"> Total por Periodo:  ${(totalExclusiveCiclo*res)} </li>
        <li class="breakdownhtmlConv"> Subtotal:  ${preTotal}</li>
        `
        ...
        <li class="breakdownhtmlConv"> ${printConvIncTotal} </li>
        <li class="breakdownhtmlConv"> ${printConvExcTotal} </li>
        <li class="breakdownhtmlConv"> Total:  ${(totalExclusiveTotal*res)} </li>
        `
	...
	.catch(err => console.error(err));
    const liBreakdownConv = document.querySelectorAll ('.breakdownhtmlConv');
    liBreakdownConv.forEach (breakdownhtmlConv => {breakdownhtmlConv.remove()});
